...
class App extends Component{
    ...
    componentDidMount(){
        console.log("component was mountend");
        this.fetchTask();
    }
                            ...
                            <div className="card">
                                <div className="card-content">
                                    <form onSubmit={this.addTask}>
                                        ...
                                        <button type="submit" className="btn btn-blue darken-4">Send</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                            ...
                                            return (
                                                <tr key={task._id}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button className="btn light-blue darken-4" onClick={() =>this.deleteTask(task._id)} style={{margin: '4px'}}><i className="material-icons">delete</i></button>
                                                    </td>
                                                </tr>
                                            )
                                        })
